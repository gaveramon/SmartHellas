...
comment on function platform.bind_operation_context_type_column() is
    'Deferred enum bind: 001 operation_context_type SSOT → platform.operation_contexts.context_type.';
...
-- run_platform_daily_maintenance: canonical definition in 014 (includes sync_service_activation_state)
...
-- 000.03.06 security hardening (admin/worker functions → service_role only)
