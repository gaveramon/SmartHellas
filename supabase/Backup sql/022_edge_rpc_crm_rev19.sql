-- =====================================================
-- 022 EDGE RPC CRM (REV19)
-- SQL SSOT: public.crm_api for CRM domain
-- =====================================================

insert into platform.schema_migrations (migration_name, version, rollback_available)
values ('022_edge_rpc_crm_rev19', 'REV19.EDGE.RPC.CRM', false)
...
begin
    ...
    when 'delete_pipeline' then
        v_result := public.edge_soft_delete_row('public.crm_pipelines'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_pipeline_stage' then
        v_result := public.edge_soft_delete_row('public.crm_pipeline_stages'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_campaign' then
        v_result := public.edge_soft_delete_row('public.crm_campaigns'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_tag' then
        v_result := public.edge_soft_delete_row('public.crm_tags'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_company' then
        v_result := public.edge_soft_delete_row('public.crm_companies'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_contact' then
        v_result := public.edge_soft_delete_row('public.crm_contacts'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_lead' then
        v_result := public.edge_soft_delete_row('public.crm_leads'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_contact_company' then
        v_result := public.edge_soft_delete_row('public.crm_contact_company'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_company_tenant' then
        v_result := public.edge_soft_delete_row('public.crm_company_tenants'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_contact_tenant' then
        v_result := public.edge_soft_delete_row('public.crm_contact_tenants'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_opportunity' then
        v_result := public.edge_soft_delete_row('public.crm_opportunities'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_task' then
        v_result := public.edge_soft_delete_row('public.crm_tasks'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'soft_delete_interaction' then
        v_result := public.edge_soft_delete_row('public.crm_interactions'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_note' then
        v_result := public.edge_soft_delete_row('public.crm_notes'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_tag_assignment' then
        v_result := public.edge_soft_delete_row('public.crm_tag_assignments'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_list' then
        v_result := public.edge_soft_delete_row('public.crm_lists'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_list_member' then
        v_result := public.edge_soft_delete_row('public.crm_list_members'::regclass, (p_payload->>'id')::uuid);
    ...
    when 'delete_custom_field' then
        v_result := public.edge_soft_delete_row('public.crm_custom_fields'::regclass, (p_payload->>'id')::uuid);
