...
-- =====================================================
-- PLATFORM EXTERNAL WEBHOOK PROCESSOR
--
-- 000 = generic platform webhook ingestion boundary
--
-- RESPONSIBILITY:
...
-- - device resolution
-- - routing to the appropriate domain boundary
--
-- =====================================================

create or replace function platform.process_external_webhook(
    p_webhook_id uuid
)
returns jsonb
language plpgsql
