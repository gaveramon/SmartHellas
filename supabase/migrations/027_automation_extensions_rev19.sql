...
-- Subscription domain ops + UI view
...
-- =====================================================
-- 0. ENSURE 016 RUNTIME OBJECTS (recovery when 016 skipped)
-- =====================================================
...
create table if not exists public.automation_runs (
    ...
    workflow_id uuid not null references public.operation_workflows(id) on delete restrict,
...
-- =====================================================
-- 1. DOMAIN SSOT — SUBSCRIPTION OPS
-- =====================================================
