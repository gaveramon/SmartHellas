...
begin
    ...
    case p_op
        when 'list_rules', 'get_rule', 'list_insight_events', 'get_insight_event', 'list_recommendations', 'get_recommendation', 'list_device_usage_scores', 'list_energy_profiles', 'get_energy_profile' then
            perform public.edge_require_tenant();
