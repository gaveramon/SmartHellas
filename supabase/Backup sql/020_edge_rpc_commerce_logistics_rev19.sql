-- =====================================================
-- 020 EDGE RPC COMMERCE & LOGISTICS (REV19)
-- SQL SSOT for commerce and logistics edge orchestration
-- =====================================================

insert into platform.schema_migrations (migration_name, version, rollback_available)
values ('020_edge_rpc_commerce_logistics_rev19', 'REV19.EDGE.RPC.COMMERCE_LOGISTICS', false)
...
begin
    ...
    case p_op
        ...
        when 'change_plan' then
            v_result := public.change_subscription_plan(
                (p_payload->>'plan_id')::uuid
            );
...
begin
    ...
    case p_op
        ...
        when 'dispatch_fulfilment_order' then
            v_result := public.dispatch_fulfilment_order(
...
-- =====================================================
-- END 020 EDGE RPC COMMERCE & LOGISTICS
-- =====================================================
